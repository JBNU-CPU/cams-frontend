          ...
          <>
            ...
            {activeTab === 'opened' && (
              <div className="space-y-4">
                {myOpenedActivities.length === 0 ? (<div className="text-center py-12"> <i className="ri-folder-open-line text-4xl text-gray-300 mb-4"></i> <p className="text-gray-500 mb-4">개설한 활동이 없습니다.</p> <Link to="/create-activity" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium"> <i className="ri-add-line mr-2"></i> 활동 만들기 </Link> </div>) : (
